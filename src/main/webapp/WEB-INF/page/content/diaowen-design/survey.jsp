...
<%--<div class="header_Item header_logo" >
		<a href="${ctx }/" ><img  style="padding-top: 6px;" alt="调问网" src="${ctx }/images/logo/LOGO-1.png" height="36" ></a>
		<span style="font-family: '微软雅黑';font-size: 16px;line-height: 46px;" id="pageHeaderSpan">&nbsp;</span>
</div>--%>
</div>
<%--<div id="header_right">
...
<div class="tools_tabs">
	...
	<div class="tools_tabs_right">
		<ul>
		<%--<li style="padding: 0px;font-size: 14px;line-height: 28px;margin-right: 22px;"><a href="${ctx}/design/my-survey.action" style="text-decoration: none;color: gray;">返回</a></li>--%>
		<li style="padding: 0px;font-size: 14px;line-height: 28px;"><a href="http://support.diaowen.net/" target="_black" style="text-decoration: none;color: gray;">帮助</a></li>
		</ul>
	</div>
</div>
...
<div class="tools_contents">
				...
				<div class="dwQuTypeModel">
						<div class="surveyQuItemBody quDragBody">
							...
							<div class="quInputCase" style="display: none;">
								...
								<input type="hidden" name="optionOneTime" value="0" id="optionOneTime">
	...
	<div id="toolsPubBtn" >
		<div class="toolbars" style="padding:10px  15px 10px 0px;">
			<ul>
			<li id="publishBtn" style="margin-right: 30px;" >
				<div class="dwToolbar_icon"></div>
			</li>
			<li id="saveＭodelBtn" style="display: none;" class="saveＭodelBtn_li">
				<div class="dwToolbar_icon"></div>
			</li>
			<li id="saveBtn" style="margin-right: 10px;">
				<div class="dwToolbar_icon"></div>
			</li>
			<!-- <li id="previewBtn" >
				<div class="dwToolbar_icon"></div>
					...
					<c:when test="${en.quType eq 'RADIO' }">
						<div class="surveyQuItemBody">
							...
							<div class="quInputCase" style="display: none;">
								...
								<input type="hidden" name="optionOneTime" value="${en.optionOneTime }">
		...
		<div class="dwCommonDialogContent">
			...
			<div class="dwQuSetCon dwQuFormSetDialog dwQuDialogCon" >
				<ul>
					...
					<li class="optionOneTime"><label><input type="checkbox" name="setOptionOneTime" id="setOptionOneTime">各选项仅可提交一次</label> </li>
			...
			<div class="tabbarDialog_1" >
					...
					<div class="p_DialogContent" >
						...
						<div class="p_DialogContentRoot">
								...
								<div class="p_DialogContentItem"><label><input type="checkbox" name="ynEndTime" value="1"> 到&nbsp;<input type="text" size="20"  class="inputSytle_1 Wdate" onfocus="WdatePicker({minDate:'%y-%M-{%d}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="endTime">&nbsp;时结束 </label></div>
						</div>
					</div>
					<div style="clear: both;"></div>
					<div class="p_DialogContent">
...
<script type="text/javascript">
	...
	$("input[name='endTime']").val("<fmt:formatDate value="${survey.surveyDetail.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/>");
