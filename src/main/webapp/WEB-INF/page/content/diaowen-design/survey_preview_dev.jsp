	...
	<div class="leftTabbar">
		<ul>
				...
				<div class="tabbarDialog">
					...
					<div class="p_DialogContent">
						...
						<div class="p_DialogContentRoot">
								...
								<div class="p_DialogContentItem"><label><input type="checkbox" name="ynEndTime" value="1"> 到&nbsp;<input value="${survey.surveyDetail.endTime}" name="endTime" type="text" size="16"  class="inputSytle_1 Wdate" onfocus="WdatePicker({minDate:'%y-%M-{%d}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" >&nbsp;时结束 </label></div>
						</div>
					</div>
					<div class="p_DialogContent">
			...
			<li style="display: none;">
				...
				<input class="paramtag" type="hidden" name="surveyHeadBgColor" value="#f7423d">
				<input class="paramtag" type="hidden" name="surveyContentBgColorMiddle" value="#FFFFFF">
				<input class="paramtag" type="hidden" name="surveyBtnBgColor" value="#f7423d">
				...
				<input class="paramtag" type="hidden" name="surveyNoteTextColor" value="#FFFFFF">
