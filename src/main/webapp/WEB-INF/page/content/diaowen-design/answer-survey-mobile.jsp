...
<script type="text/javascript" src="${ctx }/js/plugs/layer/mobile/layer.js"></script>
...
<div data-role="page" >
  <div data-role="header" style="background: #CC0000! important;">
									...
									<div class="quCoItem">
											...
											<div class="scoreRow quScoreOptionTr">
												...
												<fieldset class="starRating" data-role="controlgroup" >
													...
													<c:forEach begin="1" end="${en.paramInt02 }" var="scoreNum"><i class="fa fa-circle-o"></i></c:forEach>
...
$(document).ready(function(){
	...
	$(".starRating  .fa").hover(function(){
		...
		prevAll.removeClass("fa-circle-o");
		prevAll.addClass("fa-circle");
		...
		if(starNum==""&&starNum<=0){
			...
			fas.removeClass("fa-circle");
			fas.addClass("fa-circle-o");	
		}
	}); 
					...
					if(curQuItemId===cgQuItemId){
						...
						if(logicType==="1"){
							...
							if(logicStatus){
								...
								refShow(hidQuItemBodys); //xizhenyin
							}else{
								/*  隐藏题
								*/
								var hidQuItemBody=$(".quId[value='"+skQuId+"']").parents(".li_surveyQuItemBody");
