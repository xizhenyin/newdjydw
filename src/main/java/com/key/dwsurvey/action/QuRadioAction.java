...
public class QuRadioAction extends ActionSupport{
	...
	private Question ajaxBuildSaveOption(HttpServletRequest request) throws UnsupportedEncodingException {
	    ...
	    String optionOneTime=request.getParameter("optionOneTime");
		...
		optionOneTime=(optionOneTime==null || "".equals(optionOneTime))?"0":optionOneTime;
		...
		entity.setOptionOneTime(Integer.parseInt(optionOneTime));
