...
//    	 TODO Auto-generated method stub
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        if(this.isLoginRequest(request, response)) {
            ...
            Object djyTokenObj = request1.getSession().getAttribute("djyToken");
            System.out.println("...eee.....djyTokenObj");
            if(djyTokenObj!=null){
                return checkToken.exeLogin(request1,djyTokenObj.toString());
            }
