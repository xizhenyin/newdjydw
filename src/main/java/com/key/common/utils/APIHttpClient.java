...
//		arry.add(j);
		/////
		 ...
		 surveyDirectory.setSurveyName("222");
		 String entityToStr = gson.toJson(surveyDirectory);
		System.out.println(ac.post(entityToStr));
		
//		List<NameValuePair> formparams = new ArrayList<NameValuePair>();  
//		formparams.add(new NameValuePair("type", "girl"));  
